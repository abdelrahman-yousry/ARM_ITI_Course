...
/****************************************************************
 * Description: 		this function to set GPIO pin as Alternative Function
 *
 * input args: 			GpioPinCfg_t *PinCfg ---> i will recieve from the user address of type
 * 						struct which will have the configuration of the GPIO pin
